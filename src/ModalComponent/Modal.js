...
const { Platform, StyleSheet, I18nManager, View } = require('react-native')

const ModalComponent = require('./ModalImpl').default
...
class Modal extends React.Component {
  ...
  render(): ?React.Element<any> {
    ...
    return (
      <ModalComponent
        visible={visible}
        animationIn={ANIMATION_IN_TYPES[animationType]}
        animationOut={ANIMATION_OUT_TYPES[animationType]}
        backdropOpacity={transparent ? 0 : 1}
        onModalShow={onShow}
